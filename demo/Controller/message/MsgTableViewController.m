...
- (void)viewDidLoad {
    ...
    self.title = @"消息";
    self.definesPresentationContext = YES; // 设置这个属性，当搜索栏处于搜索时，点击cell跳转才会正常
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    vc.friendImgName = msg.person.photoName;
    vc.friendName = msg.person.nickName;
    vc.contentArray = [NSMutableArray arrayWithArray:@[msg.lastMsg]];
    vc.isSender = [NSMutableArray arrayWithArray:@[@NO]];
